...
/**
 * This class tests the remove piece method.
 */
...
public class TestRemovePiece {
    ...
    public void testRemovePiece() throws Exception{
        ...
        testGame.removePiece(testGame.gameBoard.board);

        assertTrue(testGame.gameBoard.board[1][1] == 'E');
        assertTrue(testGame.gameBoard.board[18][8] == 'E');
        assertTrue(testGame.gameBoard.board[18][11] == 'E');
    }
}
