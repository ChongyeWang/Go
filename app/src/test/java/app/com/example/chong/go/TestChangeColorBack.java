...
/**
 * This class tests the changeColorBack method
 */
...
public class TestChangeColorBack {
    @Test
    public void testChangeColorBack() throws Exception{
        ...
        testGame.changeColorBack(testGame.gameBoard.board, 'W');

        assertTrue(testGame.gameBoard.board[1][1] == 'P');
        assertTrue(testGame.gameBoard.board[17][1] == 'W');
        assertTrue(testGame.gameBoard.board[6][6] == 'W');
        assertTrue(testGame.gameBoard.board[6][7] == 'W');
        assertTrue(testGame.gameBoard.board[0][17] == 'W');
        assertTrue(testGame.gameBoard.board[1][17] == 'W');
        assertTrue(testGame.gameBoard.board[2][17] == 'W');
        assertTrue(testGame.gameBoard.board[14][14] == 'W');
