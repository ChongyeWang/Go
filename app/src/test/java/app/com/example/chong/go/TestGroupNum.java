...
/**
 * This class tests the GroupNum method.
 */

public class TestGroupNum {
    @Test
    public void testGroupNum() throws Exception {
        ...
        assertTrue(testGame.whiteGroupNum() == 7);
        assertTrue(testGame.blackGroupNum() == 17);
    }
}