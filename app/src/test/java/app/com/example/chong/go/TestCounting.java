...
/**
 * This class tests the counting method.
 */
...
public class TestCounting {
    ...
    public void testCounting() throws Exception{
        ...
        testGame.counting();
        assertTrue(testGame.countingBoard.board[18][0] == 'b');
        assertTrue(testGame.countingBoard.board[18][18] == 'W');
        assertTrue(testGame.countingBoard.board[5][5] == 'm');
        assertTrue(testGame.countingBoard.board[6][8] == 'm');
    }
}
