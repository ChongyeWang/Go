...
/**
 * This class will test the mutualLife method.
 */

public class TestMutualLife {
    @Test
    public void testMutualLife() throws Exception{
        ...
        assertTrue(testGame.mutualLife(3, 3) == true);
        assertTrue(testGame.mutualLife(1, 1) == false);
        assertTrue(testGame.mutualLife(13, 13) == true);
        assertTrue(testGame.mutualLife(18, 0) == true);
        assertTrue(testGame.mutualLife(0, 0) == false);
